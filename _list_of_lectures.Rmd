...
non_IID_errors <- list(
  ...
  topics = c("<b>Problems with model errors</b>", "Weighted least squares", "Generalized least squares", "Robust regression"),
...
transformations <- list(
  ...
  background = "[Farraway (2015) Chap 9](references/Faraway_2015_Linear_models_with_R.pdf)",
  zoom = ""
)
