...
zero_models <- list(
  ...
  topics = c("<b>Zero-truncated & zero-inflated models</b>", "Zero truncation", "Zero inflation", "Hurdle models"),
  pdf = c(""),
  rmd = c(""),
  html = c(""),
  background = c("[Faraway (2016) Chap 5](references/Faraway_2016_Extending_the_Linear_Models_with_R.pdf)", "[Zuur et al (2009) Chap 5](references/Zuur_2009_mixed_effects_models_in_R.pdf)"),
  zoom = ""
)
