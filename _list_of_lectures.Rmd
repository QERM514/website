...
more_GLMM <- list(
  ...
  rmd = c("lectures/week_09/lec_27_more_GLMMs.Rmd"),
  html = c("lectures/week_09/lec_27_more_GLMMs.html"),
  background = c("[Faraway (2016) Chap 13](references/Faraway_2016_Extending_the_Linear_Models_with_R.pdf)",
                 "[Zuur et al (2009) Chap 13](references/Zuur_2009_mixed_effects_models_in_R.pdf)",
                 "[Bolker et al (2009)](Bolker_2009_glmm_guide.pdf)"),
  zoom = ""
...
more_GAM <- list(
  ...
  rmd = c("lectures/week_10/lec_29_more_GAMs.Rmd"),
  html = c("lectures/week_10/lec_29_more_GAMs.html"),
  background = c("[Zuur et al (2009) Chap 3](references/Zuur_2009_mixed_effects_models_in_R.pdf)",
                 "[Pedersen et al (2019)](references/Pedersen_2019_hierarchical_gam.pdf)"),
  zoom = ""
)
