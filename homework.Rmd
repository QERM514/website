...
**Homework will be assigned each Friday of weeks 1-8 and will be due by 11:59 PM one week later on the following Friday (weeks 2-9)**. Students should send their completed homework to the instructor as an attachment to an email message. 
