...
**Homework will be assigned each Friday of weeks 1-8 and will be due by 11:59 PM one week later on the following Friday (weeks 2-9)**.  
...
# template_links <- lapply(week_hw, function(x) {if(is.list(x)) {x$rmd} else {""} })
# ## topics formatted for html
# template_links_html <- sapply(lapply(template_links, paste, "<br>", collapse = ""), c)
# names(template_links_html) <- NULL
