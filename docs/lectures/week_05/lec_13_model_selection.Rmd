...
```{r model_var, fig.align='center', fig.height = 4.5, fig.width = 4.5}
set.seed(514)
## num of bullet holes
nn <- 7
...
```{r model_bias, fig.align='center', fig.height = 4.5, fig.width = 4.5}
## setup plot
par(mai = c(0, 0, 0, 0),
    omi = c(0, 0, 0, 0))
## draw models
...
```{r bias_vs_var, fig.align='center', fig.height = 5, fig.width = 5.5}
## load shape pkg
library(shape)
set.seed(514)
## num of bullet holes
...
for(i in 1:4) {
  ...
  ## label plots
  if(i == 1) {
    mtext("Low bias", side = 2, line = 1, cex = 1.3)
    mtext("Low variance", side = 3, line = 1, cex = 1.3)
  }
  if(i == 2) {
    mtext("High variance", side = 3, line = 1, cex = 1.3)
  }
  if(i == 3) {
    mtext("High bias", side = 2, line = 1, cex = 1.3)
  }
}
```
...
```{r acc_vs_prec, fig.align='center', fig.height = 5, fig.width = 5.5}
set.seed(514)
## setup plot
par(mfrow = c(2,2),
    mai = c(0, 0, 0, 0),
...
for(i in 1:4) {
  ...
  ## label plots
  if(i == 1) {
    mtext("High accuracy", side = 2, line = 1, cex = 1.3)
    mtext("High precision", side = 3, line = 1, cex = 1.3)
  }
  if(i == 2) {
    mtext("Low precision", side = 3, line = 1, cex = 1.3)
  }
  if(i == 3) {
    mtext("Low accuracy", side = 2, line = 1, cex = 1.3)
  }
}
```
...
```{r var_bias_trade-off, fig.align='center', fig.height = 5, fig.width = 5.5}
...
\begin{aligned}
\lambda &= \text{-}2 \log (LR) \\
  &= \text{-}2 \log \left( \frac{\mathcal{L}(y; \theta)}{\mathcal{L}(y; \Theta)}  \right)
\end{aligned}
$$
...
$$
\begin{aligned}
\lambda  &= \text{-}2 \log \left( \frac{\mathcal{L}(y; \theta)}{\mathcal{L}(y; \Theta)}  \right) \\
&= \text{-}2 \left[ \log \mathcal{L}(y; \theta) - \log \mathcal{L}(y; \Theta)  \right]
\end{aligned}
$$
...
$\lambda = \text{-}2 \left[ \log \mathcal{L}(y; \theta) - \log \mathcal{L}(y; \Theta)  \right]$
