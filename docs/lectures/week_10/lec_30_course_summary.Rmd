...
A good analysis doesn’t have to be complicated

> * A clean and reproducible analysis is always best

> * Keep the explanation clean and elegant too


## Lesson number 3 

Stay as close to the data as possible

> * Try to work with the raw data

> * Beware of "stats on stats" 
...
Everyone should be clear on (at least) three things: 

1) What is your model (set)?

2) Why is it your model (set)?

3) How will inference from your model (set) answer your question?
...
> * Inference is conditional on the degree to which we meet our assumptions

> * Be very clear, and allow our reader to be very clear, on our assumptions
...
> * Look for the holes & confess them

> * If you can’t fix them, there is still value in the analysis

> * Maybe someone in the future (you?) will fix/solve them  
