---
title: "Zero-truncated and zero-inflated data"
...
## Sources of zeros {.smaller data-background=zero_sources.png data-background-size=70%}
...
## Hurdle models {.smaller data-background=hippo_za.png data-background-size=70%}
...
```{r hippo_data, fig.height=5, fig.width=6.5, fig.align='center'}
## Hurdle model
...
## Zero-inflated models {.smaller data-background=hippo_zi.png data-background-size=60%}
...
```{r za_zi_compare, fig.height=5, fig.width=8, fig.align='center'}
## ZAP
set.seed(514)
junk <- rpois(300, 3)
junk1 <- rep(0, 50)
...
```{r deer_data, fig.height=5, fig.width=6.5, fig.align='center'}
set.seed(514)
## sample size
nn <- 200
## parameters for detection model
