...
Recall that it has one parameter $\lambda$ to describe both the mean *and* variance
...
```{r pois_normal, fig.height = 4.5, fig.width = 8.5, fig.align = 'center'}
set.seed(514)
...
Catches of prawns $y_i$ as a function of bait type $C_i$ and water temperature $T_i$
...
```{r fitted_ci, fig.height=5, fig.width=5, fig.align='center'}
## set plot area
...
## temp vs catch
plot(temp, catch, pch = 16, las = 1, ylim = range(catch),
     ylab = "Catch", xlab ="Temperature (C)")
## with fish bait
lines(fdat$temp, fish$fit, lwd = 3, col = "blue")
lines(fdat$temp, fish$fit + t_crit * fish$se.fit, lwd = 1, col = "blue")
lines(fdat$temp, fish$fit - t_crit * fish$se.fit, lwd = 1, col = "blue")
text(7, 65, "Fish bait", pos = 4, col = "blue", cex = 1.5)
## with chicken bait
lines(cdat$temp, chkn$fit, lwd = 3, col = "darkred")
lines(cdat$temp, chkn$fit + t_crit * chkn$se.fit, lwd = 1, col = "darkred")
lines(cdat$temp, chkn$fit - t_crit * chkn$se.fit, lwd = 1, col = "darkred")
text(7, 40, "Chicken bait", pos = 4, col = "darkred", cex = 1.5)
```
