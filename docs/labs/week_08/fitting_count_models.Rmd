...
```{r prawns_plots, fig.height = 4, fig.width = 8, fig.align = 'center'}
## set plot area
par(mfrow = c(1, 2),
...
```{r plot_profile, fig.height = 4, fig.width = 8, fig.align='center', message = FALSE}
## set plot area
par(mfrow = c(1, 2),
...
```{r plot_fitted_ci, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
...
```{r resids, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
par(mai = c(0.9, 0.9, 0.6, 0.1),
    omi = c(0, 0, 0, 0),
    cex.lab = 1.3)
...
```{r plot_leverage, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
par(mai = c(0.9, 0.9, 0.6, 0.1),
    omi = c(0, 0, 0, 0),
    cex.lab = 1.3)
...
```{r plot_cooks, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
...
```{r plot_turtles, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
par(mai = c(0.9, 0.9, 0.6, 0.1),
    omi = c(0, 0, 0, 0),
    cex.lab = 1.3)
...
```{r fitted_ci_2, fig.height = 4, fig.width = 8, fig.align='center'}
## fitted values
...
```{r snake_data, fig.height = 6, fig.width = 6, fig.align='center'}
## read data
...
```{r za_zi_compare, fig.height = 4, fig.width = 8, fig.align='center'}
...
```{r plot_hippo_data, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
par(mai = c(0.9, 0.9, 0.1, 0.1),
    omi = c(0, 0, 0, 0), bg = NA,
    cex.main = 1.2, cex.lab = 1.2)
...
```{r hippo_zap_fitted, fig.height = 4, fig.width = 8, fig.align='center'}
...
```{r plot_deer_data, fig.height = 6, fig.width = 6, fig.align='center'}
## set plot area
par(mai = c(0.9, 0.9, 0.1, 0.1),
    omi = c(0, 0, 0, 0), bg = NA,
    cex.main = 1.2, cex.lab = 1.2)
...
```{r deer_zip_fitted, fig.height = 4, fig.width = 8, fig.align='center'}
## fitted for detection prob (pi)
trees <- sort(trees)
