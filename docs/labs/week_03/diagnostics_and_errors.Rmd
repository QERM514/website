---
title: "Model diagnostics and<br>problems with errors"
...
Here is a short-tailed (platykurtic) distribution. Notice that I made up a pdf based on a [Butterworth function](https://en.wikipedia.org/wiki/Butterworth_filter).
...
and $c = \widehat{\sigma} \propto \text{Median}(\left| \widehat{\epsilon} \right|)$.
