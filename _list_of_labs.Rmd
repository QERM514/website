...
helpful_functions <- list(
  title = "Data and models in R",
  topics = c("Data and models in R"),
  pdf = c(""),
  rmd = c("labs/week_01/helpful_functions.Rmd"),
  html = c("labs/week_01/helpful_functions.html"),
  zoom = "",
  data = "",
  background = c("")
)
...
last_week <- list(
  title = "Project help (no lab session)",
  topics = c("Troubleshooting project analyses"),
  pdf = "",
  rmd = "",
  html = "",
  zoom = "",
