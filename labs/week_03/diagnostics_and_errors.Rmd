...
We can see that the AR(1) coefficient $\phi$ is ~0.99, which is very high. 
...
```{r confint_AR1, eval = FALSE}
## this won't work bc the estimate var-cov matrix is not positive-definite
intervals(glmod)
```
