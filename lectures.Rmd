...
week_lecs$L23 <- intro_GLMM_1
week_lecs$L24 <- intro_GLMM_2
## week 9
week_lecs$L25 <- holiday
week_lecs$L26 <- review
...
colnames(syl_txt) <- c("Date", "Title", "Topic(s)", "Slide deck", "Source code", "Background")
rownames(syl_txt) <- NULL

## generate table
kableExtra::kable(syl_txt, format = "html", caption = " ",
                  align = "cllccl", escape = FALSE) %>%
