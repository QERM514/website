...
There will be 2 components to your project: a project plan and a final report. Both of these elements will contribute a total of 30% toward your final grade.
...
Email your project plan as a `.pdf` document to Mark.
...
1) [`report_template.Rmd`](project/report_template.Rmd)

2) [`title_page_template.tex`](project/title_page_template.tex)

If you also want to use BibTeX as reference manager for your report, you will need these two files:

1) [`jpe.csl`](project/jpe.csl)

2) [`example_refs.bib`](project/example_refs.bib)

All of these files will need to be located in the same folder or directory. See the report template for instructions.
...
Email your project report as a `.pdf` document to Mark along with any files used to generate it, and any supporting data files as well.
