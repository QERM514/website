...
Please use the [RMarkdown report template files](https://github.com/QERM514/website/tree/master/project) for your final report, which will facilitate proper formatting of text, equations, code, figures, references, etc. At a minimum, you will need these two files:
