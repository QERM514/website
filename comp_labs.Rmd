...
**NOTE: All lectures will be delivered synchronously via [Zoom](https://washington.zoom.us/j/946943308)**
...
colnames(syl_txt) <- c("Date", "Topic(s)", "Handout(s)", "Source code", "Data", "Reference(s)")
