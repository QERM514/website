...
## empty list for labs
week_labs <- vector("list", 11)
names(week_labs) <- paste0("L", seq(0, 10))
## lab topics
week_labs$L0 <- markdown
week_labs$L1 <- helpful_functions
