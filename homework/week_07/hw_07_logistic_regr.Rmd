...
h) Fit a logistic regression model with survival as a function of the resids from (g) and compute the $R^2$ value. Plot the model residuals against `day` and describe any possible problems with this model.
