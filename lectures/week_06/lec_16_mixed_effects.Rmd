...
$$
y_{i} = \underbrace{\beta x_{i} + \alpha}_{\text{fixed}} + \underbrace{\epsilon_{i,j}}_{\text{random}} 
$$
...
$$
y_{i,j} = \underbrace{\beta_j x_{i,j} + \alpha_{j}}_{\text{fixed}} + \underbrace{\epsilon_{i,j}}_{\text{random}} 
$$
...
$$
y_{i,j} = \underbrace{\beta x_{i,j}}_{\text{fixed}} + \underbrace{\alpha_{j} + \epsilon_{i,j}}_{\text{random}} 
$$
...
$$
y_{i,j} = \underbrace{ \beta_j x_{i,j} + \alpha_{j} + \epsilon_{i,j}}_\text{random}
$$

$\epsilon_{i,j} \sim \text{N}(0,\sigma_\epsilon)$

$\beta_{j} \sim \text{N}(0,\sigma_\beta)$
