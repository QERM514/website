...
Similarly, the observations $y_i$ might sums of several pieces of raw data
...
> - heteroskedastic errors where $\text{Var}(e_i) \propto n_i$
...
Recall that our goal in ordinary least squares is to minimize the $SSE$
