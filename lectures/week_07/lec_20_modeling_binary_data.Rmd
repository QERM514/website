...
If the odds are $k$-to-1 against something, which we can write as $o = 1/k$, then
...
For example, if $k$ = 4, then $p = \frac{1}{1 + 4} = 0.2$

For example, if $p$ = 0.8, then $k = \frac{1 - 0.8}{0.8} = \frac{1}{4}$
...
lines(sl, p_hat, lwd = 2)
points(df[70,"length"], df[70, "age"], pch = 1, cex = 2)
text(df[70,"length"], df[70, "age"], "70", pos = 3, offset = 0.8)
points(df[72,"length"], df[72, "age"], pch = 1, cex = 2)
text(df[72,"length"], df[72, "age"], "72", pos = 1, offset = 0.8)
