...
Survival of fish from eggs to adulthood 
...
$$
y_i = \beta_0 + \beta_1 x_i + \epsilon_i ~ \text{with} ~ \epsilon_i \sim \text{N}(0,\sigma)
$$
...
$$
y_{i,j} = \underbrace{\beta_0 + \beta_1 x_{i,j} + \delta_{j}}_{\text{fixed}} + \underbrace{\epsilon_{i,j}}_{\text{random}} 
$$
...
$$
y_{i,j} = \underbrace{\beta_0 + \beta_1 x_{i,j}}_{\text{fixed}} + \underbrace{\delta_{j} + \epsilon_{i,j}}_{\text{random}} 
$$
