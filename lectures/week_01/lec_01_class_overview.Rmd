...
1. Based on the data, what is the distributional form of the random processes?

```{r error_dist_ex, fig.height = 4, fig.width = 7, fig.align = 'center'}
par(mfrow = c(1, 2), mai = c(0.5, 0.5, 0.5, 0), omi = rep(0, 4), bg = NA)
...
plot(c(7, 33), c(7, 33), type = "n", xlim = c(7, 33), ylim = c(7, 33),
     ...
     bty = "n")
symbols(xx, yy, circle = rep(2, 4), inches = 0.5, add = TRUE, bg = "white")
